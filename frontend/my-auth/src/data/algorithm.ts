...
export const algorithms: Algorithm[] = [
  {
    ...
    slug: "bubble-sort",
    description: "Thuật toán sắp xếp đơn giản dựa trên việc hoán đổi các phần tử kề nhau.",
  ...
  },
  {
    ...
    slug: "binary-search",
    description: "Tìm kiếm vị trí của một giá trị trong mảng đã sắp xếp.",
    ...
    category: {
      id: 14,
      name: "Searching",
      description: "Các thuật toán tìm kiếm"
    }
  }
];